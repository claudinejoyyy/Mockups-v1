...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 19, 2018 at 01:20 PM
...
CREATE TABLE IF NOT EXISTS `bed` (
  ...
  `discharge_timestamp` timestamp NOT NULL,
...
INSERT INTO `bed` (`bed_id`, `type`, `status`, `allotment_timestamp`, `discharge_timestamp`, `description`, `patient_id`) VALUES
(1, 'OPD', 1, '2017-11-28 23:36:23', '2017-11-29 22:27:10', 'blah blah blah blah blah blah blah blah', 1);
...
INSERT INTO `patient` (`patient_id`, `name`, `address`, `sex`, `birth_date`, `age`, `blood_type`) VALUES
(1, 'Patient', '#5 loakan baguio city', 1, '1997-11-14', 19, 'A'),
(4, 'qwe', 'qwe', 1, '1997-11-14', 12, 'A');
